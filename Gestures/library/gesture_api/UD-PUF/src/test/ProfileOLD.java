 ...
 */
public class ProfileOLD implements Serializable {
    /**
     * serial version id
     */
    ...
    public ProfileOLD(List<Response> normalizedResponses, List<Double> time_lengths, List<Double> motion_event_counts) {
