...
class trainer:
	...
	#TODO implement more machine learning algorithms and see how they do
	#TODO write a function to determine the accuracy of a given prediction model given N data sets; graph this data? is there a python library for graphing?
