...
public class MainActivity extends Activity
{
    ...
    private Point P1()
    {
        int x = 100+rng.nextInt(500);
        int y = 150+rng.nextInt(338);
        return new Point(x,y,0);
    }

    private Point P2()
    {
        int x = 600+rng.nextInt(500);
        int y = 150+rng.nextInt(338);
        return new Point(x,y,0);
    }
    ...
    {
        int x = 100+rng.nextInt(450);
        int y = 150+rng.nextInt(625);
        return new Point(x,y,0);
    }

    private Point randPntInBndstr()
    {
        int x = 650+rng.nextInt(450);
        int y = 150+rng.nextInt(625);
        return new Point(x,y,0);
    }
