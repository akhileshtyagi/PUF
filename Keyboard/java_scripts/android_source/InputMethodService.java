///This is a modified version of InputMethodService.java which builds a history of user input to be used in the creation of a Marcov model for authentication of the user.
///modified methods:
	//onKeyDown()
...
public class InputMethodService extends AbstractInputMethodService {
	...
	private static ChainBuilder chain_builder = new ChainBuilder();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		// add the thouch to our model
		add_touch_to_model(keyCode, event);

        return doMovementKey(keyCode, event, MOVEMENT_DOWN);
    }


	/// add a touch to our model
	private void add_touch_to_model(int keyCode, KeyEvent event){
		//create a touch object
		Touch touch;

		touch = new Touch(keyCode, ,event.getEventTime());

		//insert this touch object into the model
		chain_builder.handle_touch(touch);
	}
