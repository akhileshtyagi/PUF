...
returns the result of the authentication. This method does not provide any guarentees that the compairason has finsihed yet. If the compairason has not yet finished it will return false; \index{runtime\+::\+Compare\+Chains@{runtime\+::\+Compare\+Chains}!run@{run}}
