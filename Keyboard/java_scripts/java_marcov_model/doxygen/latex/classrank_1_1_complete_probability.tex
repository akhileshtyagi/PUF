...
This class computes probability in a different way from what is contained in the Chain class. This class looks at all of the touches to try to determine the probability that from any given touch, it transitions to another.
