...
public class Model_compare {
	...
	private final static int[] token_sizes = {5,10};
	private final static int[] thresholds = {5000};
	private final static int[] user_model_sizes = {4000,5000,6000};
	private final static int[] auth_model_sizes = {2000,3000,4000};
