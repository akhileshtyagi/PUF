...
public class Model_compare {
	...
	private static int[] user_model_sizes = {2000,4000,6000,8000,10000};//new int[10]; //5000
	private static int[] auth_model_sizes = {2000,4000,6000,8000,10000};//new int[10]; //4000
