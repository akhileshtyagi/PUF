...
Consumer Reports \cite{CR14} %TODO ?
reported over $3.1$ million smart phone thefts in $2013$. 
Federal Communications Commission (FCC)\cite{FCC14} %TODO ?
...
%TODO potentially analyzing the screen for commonly traced patterns (smuge attacks)
...
%TODO cite some attacks like "look over shoulder attacks" and smuge
...
%TODO use some other examples of lock screens
These vulnerabilities have led to the development of 
lock screens which .
%TODO finger print scanners and facial recognition
...
%TODO
%
%TODO talk about how finger print scanners and facial recognition may be exploited
Finger print scanner may be exploited in 
x \cite{cao2016hacking}%TODO 
as shown by 
y%TODO.
...
%
%TODO many people neglect to use a lock screen at all
\cite{harbach2014sa}
