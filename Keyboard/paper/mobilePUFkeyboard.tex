...
%TODO describe in depth the continuious authentication scheme proposed, this is where the main contributions of this work should be discussed

%TODO describe the structure of the paper, what is contained in each section
...
%explain why are solution is better then previous/other solutions
...
%TODO explain what each of the metrics used in the figure are.
%

\section{Conclusions}
\label{sec:conclusions}
%describe what has been presented in the paper
This paper presents an approach toward continuious authentication which utilizes the variability in the way users interact with the touchscreens of their devices to differentiate distinct user-device combinations. Data for this approach comes from %TODO

%describe the design space for the system presented in the paper
