 ...
 * or finished.
 */
public class ActivityOriginal extends ContextThemeWrapper
        implements LayoutInflater.Factory2,
        Window.Callback, KeyEvent.Callback,
        OnCreateContextMenuListener, ComponentCallbacks2,
        Window.OnWindowDismissedCallback {
    private static final String TAG = "ActivityOriginal";
    ...
    public final ActivityOriginal getParent() {
        return mParent;
    }
    ...
    private void startIntentSenderForResultInner(IntentSender intent, int requestCode,
            Intent fillInIntent, int flagsMask, int flagsValues, ActivityOriginal activity,
            Bundle options)
            throws IntentSender.SendIntentException {
        try {
     ...
     * @see #startActivityForResult
     */
    public void startActivityFromChild(@NonNull ActivityOriginal child, Intent intent,
            int requestCode) {
     ...
     */
    public void startIntentSenderFromChild(ActivityOriginal child, IntentSender intent,
     ...
     * @see #finish
     */
    public void finishFromChild(ActivityOriginal child) {
        finish();
    }
     ...
     *                    activity.
     */
    public void finishActivityFromChild(@NonNull ActivityOriginal child, int requestCode) {
        try {
            ActivityManagerNative.getDefault()
    ...
    protected void onChildTitleChanged(ActivityOriginal childActivity, CharSequence title) {
    }
     ...
     *         not be found and this activity was simply finished normally.
     */
    public boolean navigateUpToFromChild(ActivityOriginal child, Intent upIntent) {
    ...
    final void setParent(ActivityOriginal parent) {
        mParent = parent;
    }
    ...
    final void attach(Context context, ActivityThread aThread,
            ...
            CharSequence title, ActivityOriginal parent, String id,
    ...
    class HostCallbacks extends FragmentHostCallback<ActivityOriginal> {
        public HostCallbacks() {
            super(ActivityOriginal.this /*activity*/);
        }

        @Override
        public void onDump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
            ActivityOriginal.this.dump(prefix, fd, writer, args);
        }
        ...
        public LayoutInflater onGetLayoutInflater() {
            final LayoutInflater result = ActivityOriginal.this.getLayoutInflater();
            if (onUseFragmentManagerInflaterFactory()) {
                return result.cloneInContext(ActivityOriginal.this);
            }
            return result;
        }
        ...
        @Override
        public ActivityOriginal onGetHost() {
            return ActivityOriginal.this;
        }

        @Override
        public void onInvalidateOptionsMenu() {
            ActivityOriginal.this.invalidateOptionsMenu();
        }

        @Override
        public void onStartActivityFromFragment(Fragment fragment, Intent intent, int requestCode,
                Bundle options) {
            ActivityOriginal.this.startActivityFromFragment(fragment, intent, requestCode, options);
        }
        ...
        @Override
        public void onAttachFragment(Fragment fragment) {
            ActivityOriginal.this.onAttachFragment(fragment);
        }

        @Nullable
        @Override
        public View onFindViewById(int id) {
            return ActivityOriginal.this.findViewById(id);
        }
