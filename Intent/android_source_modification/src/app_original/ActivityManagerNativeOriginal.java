...
/** {@hide} */
public abstract class ActivityManagerNativeOriginal extends Binder implements IActivityManager
{
    /**
    ...
    static public IActivityManager asInterface(IBinder obj) {
        ...
        /** PolyResearch */
        return new ActivityManagerProxyModified(obj);
    }
    ...
    public ActivityManagerNativeOriginal() {
 ...
 * PolyResearch
 *
 * This added to override the functionality of
 * ActivityManagerProxy.
 *
 * The goal is to add the funcitonality we need in the cleanest way possible.
 */
class ActivityManagerProxyModified extends ActivityManagerProxy {
    public ActivityManagerProxyModified(IBinder remote)
    {
        super(remote);
    }
    ...
    public int startActivity(IApplicationThread caller, String callingPackage, Intent intent,
                             String resolvedType, IBinder resultTo, String resultWho, int requestCode,
                             int startFlags, ProfilerInfo profilerInfo, Bundle options) throws RemoteException {
        // An intent is being used to start an Activity
        if (intent.getComponent() != null) {
            Log.i("ActivityManager", "Timeline: Activity_launch_request id:"
                    + intent.getComponent().getPackageName());
        }

        Log.i("PolyResearch", "startActivityAsUser " + " Package Name: " + intent.getComponent().getPackageName());

        // preform all activities from super class
    ...
    public int startActivityAsUser(IApplicationThread caller, String callingPackage, Intent intent,
                                   ...
                                   int startFlags, ProfilerInfo profilerInfo, Bundle options,
                                   int userId) throws RemoteException {
        // activity astatrted as user
        Log.i("PolyResearch", "startActivityAsUser");

        // preform all activities from super class
        return super.startActivityAsUser(caller, callingPackage, intent, resolvedType, resultTo, resultWho, requestCode, startFlags, profilerInfo, options, userId);
    }
    ...
    public WaitResult startActivityAndWait(IApplicationThread caller, String callingPackage,
                                           ...
                                           int requestCode, int startFlags, ProfilerInfo profilerInfo, Bundle options,
                                           int userId) throws RemoteException {
        Log.i("PolyResearch", "startActivityAndWait");

        // preform all activities from super class
        return super.WaitResult(caller, callingPackage, intent, resolvedType, resultTo, resultWho, requestCode, startFlags, profilerInfo, options, userId);
    }
    ...
    public int startActivityWithConfig(IApplicationThread caller, String callingPackage,
                                       ...
                                       int requestCode, int startFlags, Configuration config,
                                       Bundle options, int userId) throws RemoteException {
        Log.i("PolyResearch", "startActivityWithConfig");

        // preform all activities from super class
        return super(caller, callingPackage, intent, resolvedType, resultTo, resultWho, requestCode, startFlags, profilerInfo, options, userId);
    }

    @Override
    public boolean startNextMatchingActivity(IBinder callingActivity,
                                             Intent intent, Bundle options) throws RemoteException {
        Log.i("PolyResearch", "startNextMatchingActivity");
    ...
    public boolean finishActivity(IBinder token, int resultCode, Intent resultData, boolean finishTask)
            throws RemoteException {
        Log.i("PolyResearch", "finishActivity");

        return super.finishActivity(token, resultCode, resultData, finishTask);
    }

    @Override
    public void activityIdle(IBinder token, Configuration config, boolean stopProfiling) throws RemoteException {
        Log.i("PolyResearch", "activityIdle");

        super.activityIdle(token, resultCode, resultData, finishTask);
    }

    @Override
    public void activityResumed(IBinder token) throws RemoteException {
        Log.i("PolyResearch", "activityResumed");
    ...
    @Override
    public void activityPaused(IBinder token) throws RemoteException {
        Log.i("PolyResearch", "activityPaused");

        super.activityPaused(token);
    }

    @Override
    public void activityStopped(IBinder token, Bundle state,
                                PersistableBundle persistentState, CharSequence description) throws RemoteException {
        Log.i("PolyResearch", "activityStopped");

        super.activityStopped(token, state, persistentState, description);
    }


    @Override
    public void activitySlept(IBinder token) throws RemoteException {
        Log.i("PolyResearch", "activitySlept");

        super.activitySlept(token);
    }

    @Override
    public void activityDestroyed(IBinder token) throws RemoteException
    {
        Log.i("PolyResearch", "activityDestroyed");

        super.activityDestroyed(token);
    }
}